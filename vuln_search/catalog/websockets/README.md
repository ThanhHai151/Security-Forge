...
**Status:** stub — headings in place, prose pending. See [`../ENTRY_TEMPLATE.md`](../ENTRY_TEMPLATE.md).

## What it is
_TODO._ (Missing origin checks and unvalidated WS messages enable hijacking and injection.)

## How it works
_TODO — see the deep-dive note._
...
_TODO — full payloads live in the deep-dive note._

## Defenses
_TODO. (This section is what `defense/` inverts to audit a target.)_
...
## Notable CVEs
_TODO — add 2–3 verified, illustrative CVEs for this class._

## References
- _TODO — PortSwigger / OWASP / RFC links._
